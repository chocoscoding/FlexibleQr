    ...
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to FlexibleQR.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Third-party Social Media Service</strong> refers to any website or any social network website through which a User can
        ...
        <li>
          <p>
            <strong>Website</strong> refers to FlexibleQR, accessible from{" "}
            <a
              href="https://flexibleqr.codes"
              rel="external nofollow noopener"
              target="_blank">
              https://flexibleqr.codes
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of
      ...
      <p>
        ...
        device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the{" "}
        <a
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among
      ...
      <ul>
        ...
        <li>
          ...
          affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners
      ...
      <ul>
        <li>By email: timileyinwandf@gmail.com</li>
      </ul>
    </>
  );
};
